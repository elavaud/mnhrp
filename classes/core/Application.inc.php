...
class Application extends PKPApplication {
	...
	function getDAOMap() {
		return array_merge(parent::getDAOMap(), array(
			...
			'ProposalDetailsDAO' => 'classes.article.ProposalDetailsDAO',
			'ProposalSourceDAO' => 'classes.article.ProposalSourceDAO',                    
			...
			'StudentResearchDAO' => 'classes.article.StudentResearchDAO',
