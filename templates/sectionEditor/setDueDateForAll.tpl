...
<script type="text/javascript" src="http://localhost:8888/fijihrp2/lib/pkp/js/lib/jquery/jquery.min.js"></script>
<script type="text/javascript" src="http://localhost:8888/fijihrp2/lib/pkp/js/lib/jquery/plugins/jqueryUi.min.js"></script>
...
{literal}
<script type="text/javascript" src="http://localhost:8888/fijihrp2/lib/pkp/js/lib/jquery/jquery-ui-timepicker-addon.js"></script>
<style type="text/css" src="http://localhost:8888/fijihrp2/lib/pkp/styles/jquery-ui-timepicker-addon.css"></style>
...
<div id="setDueDate">
<h3>Due Date for reviewers to review Proposal {$submission->getProposalId()}</h3>
