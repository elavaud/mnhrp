<?php return array (
  ...
  'common.openJournalSystems' => 'The Health Research Portal Portal',
  ...
  'common.homePageText' => '<p>Mongolia Health Research Portal is an <i>integrated online health research management system</i> that offers substantial benefits for all stakeholders in health research. The Portal aims to improve accountability, efficiency and quality of health research conducted in Mongolia by providing information on all ongoing research and hence increasing transparency and by streamlining the ethics review process.<br/><br/>The Portal can be used to:<br/><br/><b>Submit research proposals</b> for review to Mongolia MOH Ethics Review Committee 24x7 from anywhere. Researchers need to register on the Portal. Once registered, you will have a permanent account and be able to submit research proposal in a paper-less way and to track the review status of your proposals.<br/><br/><b>Search ongoing and completed health research</b> from January 2014 onwards through a publically accessible research registry. No registration or log-in is required to search the ongoing research.<br/><br/><b>Access complete research reports</b> for the researches  started since 2014 once the research is completed. [Since the system has been launched only in January 2014, there are no research reports in the system at present, but will be added as and when a research is completed or over time]<br/><br/><b>Access information on all the applicable guidelines, rules, and regulations</b> related to health research (being added…).<br/><br/><b>Access a “Researchers\' Directory”</b> containing information on the national and international researchers doing research in Mongolia (will be added soon...).</p>',
  ...
  'navigation.journalHelp' => 'Health Research Portal Help',
  ...
  'common.queue.long.proposalsToSubmit' => 'Proposals to submit',
  'common.queue.short.proposalsToSubmit' => 'To submit',
  'common.queue.long.ongoingResearches' => 'Ongoing researches',
  'common.queue.short.ongoingResearches' => 'Ongoing',
  'common.queue.long.completedResearches' => 'Completed researches',
  'common.queue.short.completedResearches' => 'Completed',
  ...
  'common.queue.long.submissionsSubmitted' => 'Proposals Submitted',
  'common.queue.short.submissionsSubmitted' => 'Submitted',
  'common.queue.long.submissionsCompleted' => 'Completed Researches',
  'common.queue.short.submissionsCompleted' => 'Completed',
  'common.queue.long.proposalsInReview' => 'Proposals under Review',
  'common.queue.short.proposalsInReview' => 'In Review',
  'common.queue.short.submissionsApproved' => 'Ongoing',
  'common.queue.short.submissionsNotApproved' => 'Not Approved',
  'common.queue.long.submissionsNotApproved' => 'Not Approved Proposals',
  'common.queue.long.submissionsArchives' => 'Archived Proposals',
  'common.queue.short.submissionsArchives' => 'Archives',
  'common.queue.long.active' => 'Active Proposals',
  'common.queue.short.active' => 'Active',
  'common.queue.long.completed' => 'Archived Proposals',
  'common.queue.long.submissionsApproved' => 'Ongoing Researches',
  'common.queue.short.completed' => 'Archive',
  'common.queue.short.meetingProposals' => 'Proposals',
  'common.queue.short.reviewAssignments' => 'Review Assignments',
  'common.queue.long.meetingProposals' => 'Proposals from meetings',
  'common.queue.short.meetingList' => 'Meetings',
  'common.queue.long.meetingList' => 'List of meetings',
  'common.queue.long.viewMeeting' => 'View Meeting',
  'institution.government' => 'Government',
  'institution.institution' => 'Institution',
  'institution.institutions' => 'Institutions',
  'institution.location' => 'Location',
  'institution.private' => 'Private',
  'institution.type' => 'Type',
  'section.section' => 'Ethics Review Committee',
  'section.sectionAbbrev' => 'Committee',
  'section.sections' => 'Ethics Review Committees',
  ...
  'article.journalSection' => 'Ethics Review Committee',
  'article.file' => 'File',
  'article.files' => 'Files',
  ...
  'article.sectionEditor' => 'Secretary Administrative Assistant',
  ...
  'article.submission' => 'Proposal',
  'article.submissions' => 'Proposals',
  ...
  'proposal.scientificTitle' => 'Scientific title',
  ...
  'proposal.studyMethods' => 'Study Methods',
  'proposal.studyMethodsInstruct' => 'Relevant features of study design (qualitative/quantitative, cross-sectional survey/case-control...), estimated sample size, manner of data collection, etc. [e.g. study involves key informant interviews with policy-makers, involving 6-8 people at national or provincial level...]',
...
•	to take responsibility for the accuracy of trial registration information submitted.',
  ...
  'proposal.phd' => 'Ph.D.',
  'proposal.proposalCountryInstruct' => 'Geographical area(s) where the research take place.',
  ...
  'proposal.abstractInstruct' => 'Short description of the primary purpose of the protocol, including a brief statement of the study hypothesis. Include publication/s details (link/reference), if any.',
  ...
  'proposal.randomlySelectedProvince' => 'Yes, with randomly selected geographical areas',
  ...
  'proposal.nationwide' => 'Nationwide research',
  ...
  'proposal.proposalCountry' => 'Region(s)',
  'proposal.otherInternationalGrantName' => 'Please specify the agency:',
  ...
  'proposal.reviewedByOtherErc' => 'Proposal reviewed by other Committee',
  'proposal.rtoOffice' => 'Office',
  'proposal.otherErcDecision' => 'If yes, other Committee Decision',
  ...
  'proposal.mohGrant' => 'Ministry of Health grant',
  ...
  'proposal.genetic' => 'Human genetic or genomic studies?',
  ...
  'submission.editorDecision' => 'Committee Decision and Review',
  ...
  'submission.editorReview' => 'Secretary Review',
  'submission.notifyAuthor' => 'Notify Investigator',
  'submission.notifyEditor' => 'Notify Secretary',
  'submission.editorAuthorRecord' => 'Secretary/Investigator Email Record',
  'submission.reviewersVersion' => 'Reviewer\'s annotated version of file',
  'submission.postReviewVersion' => 'Post-review version of file',
  'submission.editorVersion' => 'Secretary Version',
  ...
  'submissions.editorDecision' => 'Committee Decision',
  'submissions.editorRuling' => 'Committee Ruling',
  ...
  'user.noRoles.regReviewer' => 'Register as a Committee Member',
  'user.noRoles.regReviewerClosed' => 'Register as a Committee Member: Committee Member registration is currently disabled.',
  'user.role.manager' => 'Administrator',
  'user.role.editor' => 'Secretary',
  'user.role.coordinator' => 'Coordinator',
  'user.role.sectionEditor' => 'Secretary',
  'user.ercrole.chair' => 'Chair',
  'user.ercrole.viceChair' => 'Vice-Chair',
  'user.ercrole.secretariat' => 'Secretariat',
  'user.ercrole.ercMembers' => 'Committee Members',
  'user.ercrole.extReviewer' => 'External Reviewer',
  'user.ercrole.extReviewers' => 'External Reviewers',
  'user.ercrole.extMembers' => 'External Members (non-affiliated members)',
  'user.ercrole.status' => 'Committee Member Status',
  'user.role.reviewer' => 'Committee Member',
  ...
  'submission.event.editor.editorAssigned' => 'Secretary assigned to proposal',
  'submission.event.editor.editorUnassigned' => 'Secretary unassigned from submission',
  'submission.event.editor.editorDecision' => 'Secretary decision submitted',
  'submission.event.editor.editorFile' => 'Committee file updated',
  ...
  'submission.event.copyedit.copyeditorAssigned' => 'Copyeditor assigned to proposal',
  ...
  'submission.event.proofread.proofreaderAssigned' => 'Proofreader assigned to proposal',
  'submission.event.proofread.proofreaderUnassigned' => 'Proofreader unassigned from proposal',
  ...
  'submission.event.layout.layoutEditorAssigned' => 'Layout editor assigned to proposal',
  'submission.event.layout.layoutEditorUnassigned' => 'Layout editor unassigned from proposal',
...
<p>The system could not automatically overwrite the configuration file. To apply your configuration changes you must open <tt>config.inc.php</tt> in a suitable text editor and replace its contents with the contents of the text field below.</p>',
  ...
  'manager.setup.reviewProcessEmailDescription' => 'The Committee Secretary sends
to the Committee Members the request to review with the proposal attached to the email. Committee Members email the Secretary their assent (or regrets), as well as the review and recommendation. The Secretary enters the Committee Member\'s assent (or regrets), as well as the review and recommendation on the proposal\'s Review page, to record the review process.',
...
Active is how many reviews are currently being considered or underway.',
  ...
  'sectionEditor.noneAssigned' => 'No proposals assigned.',
  ...
  'sectionEditor.review.enrollReviewer' => 'Enroll an Existing User',
  'sectionEditor.review.createReviewer' => 'Create A New Committee User',
  ...
  'reviewer.submissions' => 'Proposals',
  'reviewer.meeting' => 'Meeting',
  'reviewer.meetings' => 'Meetings',
  'reviewer.proposals' => 'Meetings',
  'reviewer.meetings.submissions' => 'Proposals to be Discussed',
  'reviewer.meetings.noSubmissions' => 'No Proposals',
  'reviewer.meetings.lastReply' => 'Last reply',
  'reviewer.meetings.replyStatus' => 'Reply Status',
  'reviewer.meetings.erc' => 'Ethics Review Committee',
  ...
  'reviewer.article.editorToEnter' => 'Committee Secretary To Enter',
  ...
  'reviewer.article.uploadedFile' => 'Uploaded file',
  ...
  'reviewer.article.schedule.request' => 'Secretary\'s Request',
  ...
  'reviewer.article.schedule.isAttending' => 'Are you going to attend?',
  'reviewer.article.schedule.editAnswer' => 'Edit answer',
  'reviewer.article.schedule.editAnswerHide' => 'Hide edit',
  ...
  'reviewer.article.downloadSubmission' => 'Click on file names to download and review (on screen or by printing) the files associated with this proposal.',
  ...
  'reviewer.article.enterReviewA' => 'For more information, please click on the bubble icon to open a chat room between you and the secretary of your committee.',
  'reviewer.article.uploadFile' => 'Please upload the reivew of the proposal here.',
  'reviewer.article.selectRecommendation' => 'Select a recommendation and submit the review to complete the process. You must upload your review file before selecting a recommendation.',
...
<li>Click Upload on this page, which uploads the file from the computer to the web site and renames it following the Health Research Portal naming conventions.</li>
<li>Once the proposal is uploaded, click Save and Continue at the bottom of this page.</li>
</ol>',
  ...
  'submission.comments.editorAuthorCorrespondence' => 'Secretary/Investigator Correspondence',
...
(After saving, further comments can be added.)',
  ...
  'submission.comments.forAuthorEditor' => 'For Investigator and Secretary',
  'submission.comments.forEditor' => 'For Secretary',
...
current password.<br /><br />Enter your email address below to reset your password. A confirmation will be sent to this email address.',
  ...
  'user.register.reviewerDescriptionNoInterests' => 'Willing to conduct peer review of proposals to the journal.',
  'user.register.reviewerDescription' => 'Willing to conduct peer review of proposals to the press.',
...
<li>Use <strong>*</strong> in a term as a wildcard to match any sequence of characters; e.g., <em>soci* morality</em> would match documents containing "sociological" or "societal"</li>
  ...
  'search.dateSubmitted' => 'Date submitted',
  ...
  'search.region' => 'Geographical Area',
  'search.researchField' => 'Research Field',
  'search.researchDates' => 'Research Dates',
  ...
  'about.aboutTheJournal' => 'About the Health Research Portal',
  'about.history' => 'Health Research Portal History',
  'about.editorialTeam' => 'The Ethics Committee of the University of Health Sciences',
  ...
  'about.submissions' => 'Proposals',
  'about.sponsors' => 'Sponsors',
  'about.contributors' => 'Sources of Support',
  'about.onlineSubmissions' => 'Online Proposals',
  ...
  'about.onlineSubmissions.registrationRequired' => 'Registration and login are required to submit items online and to check the status of current proposals.',
  'about.authorGuidelines' => 'Investigator Guidelines',
  'about.submissionPreparationChecklist' => 'Submission Preparation Checklist',
  'about.submissionPreparationChecklist.description' => 'As part of the proposal process, authors are required to check off their proposal\'s compliance with all of the following items, and proposals may be returned to authors that do not adhere to these guidelines.',
  ...
  'about.journalSponsorship' => 'The Health Research Portal Sponsorship',
  ...
  'about.aboutOJSJournal' => 'This Health Research Portal uses Open Journal Systems {$ojsVersion}, which is open source journal management and publishing software developed, supported, and freely distributed by the <a href="http://pkp.sfu.ca/">Public Knowledge Project</a> under the GNU General Public License.',
  ...
  'payment.alreadyPaidMessage' => 'Select this box if you\'ve already sent your payment to the journal in order to finish the submission process.  The proposal will not be reviewed until the payment arrives.  Click PAY NOW above to see the payment instructions.',
...
<p>If you haven\'t already registered and wish to receive news and updates, <strong>please register at <a href="http://pkp.sfu.ca/ojs/register" target="_new">http://pkp.sfu.ca/ojs/register</a>.</strong> If you have questions or comments, please visit the <a href="http://pkp.sfu.ca/support/forum" target="_new">support forum</a>.</p>',
  'log.author.submitted' => '{$authorName} has entered a new proposal, ID {$submissionId}.',
  'log.author.documentRevised' => '{$authorName} has revised article {$articleId}. The new file ID is {$fileId}.',
  'log.review.reviewerAssigned' => '{$reviewerName} has been assigned to review proposal {$articleId}.',
  'log.review.reviewerUnassigned' => '{$reviewerName} has been unassigned from reviewing proposal {$articleId} for review round {$round}.',
  'log.review.reviewInitiated' => 'The round {$round} review by {$reviewerName} for proposal {$articleId} has been initiated.',
  'log.review.reviewReinitiated' => 'The round {$round} review by {$reviewerName} for proposal {$articleId} has been reinitiated.',
  'log.review.reviewCancelled' => 'The review by {$reviewerName} for proposal {$articleId} has been cancelled.',
  'log.review.reviewCleared' => 'The review by {$reviewerName} for proposal {$articleId} has been cleared.',
  'log.review.reviewerRated' => '{$reviewerName} has been rated for the review of proposal {$articleId}.',
  'log.review.reviewDueDateSet' => 'The due date for the review of proposal {$articleId} by {$reviewerName} has been set to {$dueDate}.',
  'log.review.reviewRecommendationSet' => 'The recommendation for the review of proposal {$articleId} by {$reviewerName} has been set.',
  'log.review.reviewRecommendationSetByProxy' => 'The recommendation for the review of proposal {$articleId} has been set by the editor, {$editorName}, on behalf of the reviewer, {$reviewerName}.',
  'log.review.resubmit' => 'The proposal {$articleId} has been resubmitted for review.',
  'log.review.reviewDeclined' => '{$reviewerName} has declined the round {$round} review for proposal {$articleId}.',
  'log.review.reviewAccepted' => '{$reviewerName} has accepted the review for proposal {$articleId}.',
  'log.review.reviewDeclinedByProxy' => '{$userName} has declined the review for proposal {$articleId} on behalf of {$reviewerName}.',
  'log.review.reviewAcceptedByProxy' => '{$userName} has accepted the review for proposal {$articleId} on behalf of {$reviewerName}.',
  'log.review.reviewFileByProxy' => 'The Editor, {$userName}, has uploaded a review file for the proposal {$articleId} on behalf of the reviewer, {$reviewerName}.',
  'log.review.reviewerFile' => 'A reviewer file has been uploaded.',
  'log.editor.decision' => 'A decision ({$decision}) for proposal {$proposalId} was recorded by {$editorName}.',
  'log.copyedit.initiate' => 'Copyediting on proposal {$articleId} has been commenced by {$copyeditorName}.',
  'log.copyedit.copyeditFileSet' => 'The default copyedit file has been chosen.',
  'log.copyedit.initialEditComplete' => '{$copyeditorName} has completed the initial copy edit of proposal {$articleId}.',
  'log.copyedit.finalEditComplete' => '{$copyeditorName} has completed the final copy edit of proposal {$articleId}.',
  'log.copyedit.copyeditorAssigned' => '{$copyeditorName} has been assigned to copyedit proposal {$articleId}.',
  'log.copyedit.copyeditorFile' => 'A copyeditor version of the proposal file has been uploaded.',
  'log.copyedit.authorFile' => 'A version of the proposal file copyedited by the author has been uploaded.',
  'log.layout.layoutEditorAssigned' => '{$editorName} has been assigned as layout editor for proposal {$articleId}.',
  'log.layout.layoutEditorUnassigned' => '{$editorName} has been unassigned as layout editor for proposal {$articleId}.',
  'log.layout.layoutEditComplete' => '{$editorName} has completed layout editing for proposal {$articleId}.',
  'log.editor.metadataModified' => 'The metadata for this article was modified by {$editorName}.',
  'log.editor.editorFile' => 'An editor version of the proposal file has been uploaded.',
  'log.editor.archived' => 'The proposal {$articleId} has been archived.',
  'log.editor.restored' => 'The proposal {$articleId} has been restored to the queue.',
  'log.editor.editorAssigned' => '{$editorName} has been assigned as editor to proposal {$articleId}.',
  'log.editor.submissionExpedited' => '{$editorName} has expedited the editing process for article {$articleId}.',
  'log.proofread.assign' => '{$assignerName} has assigned {$proofreaderName} to proofread proposal {$articleId}.',
  ...
  'rt.admin.options' => 'The Health Research Portal Item Tools',
  'rt.admin.relatedItems' => 'Related Item Tools',
  'rt.admin.settings.addComment' => 'Add comment (enables readers to post comments, with the Health Research Portal Manager able to delete).',
...
Validation may fail on search URLs that require posted form data.',
  ...
  'user.authorization.invalidCopyditorSubmission' => 'Invalid copyeditor proposal or no copyeditor proposal requested!',
  'user.authorization.invalidSectionEditorSubmission' => 'Invalid section editor proposal or no section editor proposal requested!',
