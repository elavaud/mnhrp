<?php return array (
  ...
  'submission.continuingReview' => 'Continuing Review',
  'submission.decisionFile' => 'Decision File',
  ...
  'submission.endOfStudy' => 'End of Study',
  ...
  'submission.initialReview' => 'Initial Review',
  ...
  'submission.page.proposalFromMeeting' => '{$id} Information',
  'submission.page.summary' => '{$id} Summary',
  'submission.page.citations' => '{$id} Citations',
  'submission.peerReview' => 'Peer&nbsp;Review',
  'submission.previousProposalFile' => 'Previous proposal file(s)',
  'submission.previousProposalFileInstruct' => 'In case of a re-submission, here are the main proposal files previously submitted. Plese click on their title to download them.',
  'submission.proposalDetails' => 'Proposal Details',
  'submission.protocolAmendment' => 'Protocol Amendment',
  ...
  'submission.reviewFiles' => 'Review File(s)',
  'submission.reviewVersion' => 'Review Version',
  'submission.saveMetadata' => 'Save Metadata',
  'submission.seriousAdverseEvents' => 'Serious Adverse Events',
  'submission.status.approved' => 'Approved',
  'submission.status.complete' => 'Complete',
  'submission.status.completed' => 'Completed',
  'submission.status.continuingReview' => 'Continuing Review',
  'submission.status.declined' => 'Declined',
  'submission.status.draft' => 'Draft',
  'submission.status.exempted' => 'Exempted From Review',
  'submission.status.expeditedReview' => 'Expedited Review',
  'submission.status.fullReview' => 'Full Review',
  'submission.status.incomplete' => 'Incomplete',
  'submission.status.resubmitted' => 'Re-submitted',
  'submission.status.reviewed' => 'Reviewed',
  'submission.status.reviseAndResubmit' => 'Revise and Resubmit',
  'submission.status.submitted' => 'Submitted',
  'submission.status.withdrawn' => 'Withdrawn',
  'submissions.active' => 'ACTIVE PROPOSALS (Awaiting Decision/Revise and Resubmit)',
  'submissions.approved' => 'APPROVED PROPOSALS (Research Ongoing)',
  'submissions.archived' => 'Archived',
  'submissions.completed' => 'Completed',
  'submissions.declined' => 'DECLINED PROPOSALS',
  'submissions.incomplete' => 'Incomplete',
  'submissions.noSubmissions' => 'No Submissions',
  'submissions.proposal.s' => 'Proposal(s)',
  ...
  'submission.submissionManuscript' => 'Main proposal file',
  ...
  'submission.titleAndAbstract' => 'Titles and abstract',
