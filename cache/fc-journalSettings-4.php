...
Mongolia Health Research Portal',
  ...
  array (
    0 => 
    array (
      'institution' => 'World Health Organization - Western Pacific Regional Office',
      'url' => 'www.wpro.who.int',
    ),
  ),
  ...
  'description' => 
  array (
    'en_US' => 'Before submitting, please read the <a title="ERC Standard Operating Procedures" href="/public/ERC_SOP_Final2010_web.pdf" target="_blank">ERC Standard Operating Procedures.</a>',
  ),
  'authorGuidelines' => 
  array (
    'en_US' => 'Before commencing the submission process, please make sure that you have read the <a title="ERC Standard Operating Procedures" href="/public/ERC_SOP_Final201_web.pdf" target="_blank">ERC Standard Operating Procedures.</a>',
  ),
  ...
  'title' => 
  array (
    'en_US' => 'Mongolia Health Research Portal',
  ),
  'journalPaymentsEnabled' => false,
  'currency' => 'USD',
  'submissionFeeEnabled' => false,
  'submissionFeeName' => 
  array (
  ...
  array (
    ...
    array (
      ...
      array (
        'order' => '1',
        'content' => 'I agree to provide final report of the research study (both electronic and a hard copy) no later than 12 months after completion of data collection/field work to MoH. Mn version',
      ),
      1 => 
      array (
        'order' => '2',
        'content' => 'I agree to provide complete raw data set used for final analysis of the research study (both electronic and a hard copy) no later than 12 months after completion of data collection /field work to MoH. Mn version',
      ),
    ),
  ),
); ?>