<?php return array (
  ...
  'about.contact' => 'The National Ethics Committee for Health Research',
  'about.contact.email' => 'Email',
  'about.contact.fax' => 'Fax',
  'about.contact.phone' => 'Phone',
  'about.contact.principalContact' => 'Secretary',
  'about.contact.subPrincipalContact' => 'Secretary Administrative Assistant',
  'about.contact.supportContact' => 'Support Contact',
  'about.other' => 'Other',
  'about.people' => 'Institutional Review Boards',
  'about.policies' => 'Policies',
  'about.siteMap' => 'Site Map',
  'about.templates' => 'Report Template(s)',
  'about.userGuides' => 'User Guide(s)',
  ...
  'common.enroll' => 'Enrol user as :',
  'common.enrollment.info1' => '* A member status is required.<br/>&nbsp;&nbsp;Please take note that only 5 secretaries, 1 Chair, 1 Vice-Chair and 20 Members are allowed per committee.<br/>&nbsp;&nbsp;If the user you are looking for is registerd into this portal but is not included in the above list, the user',
  ...
  'common.hour' => 'Hour',
  'common.id' => 'ID',
  'common.idInstruct' => 'Identification code of the research proposal.',
  'common.proposalId' => 'Proposal ID',
