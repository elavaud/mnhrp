<?php return array (
  ...
  'user.profile.form.ercStatusRequired' => 'A committee status is required.',
  ...
  'user.register.form.tooManyMembers' => 'Too many people are enrolled in your committee with the selected status. Please take note that only up to 5 secretaries, 1 chair, 1 Vice-Chair, and 20 Members are allowed (the chair and the vice-chair are considered as members).',
  ...
  'user.register.completeForm' => 'Fill in this form to register to the Health Research Portal.',
); ?>