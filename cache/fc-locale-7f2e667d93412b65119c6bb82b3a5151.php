<?php return array (
  ...
  'manager.groups.noneCreated' => 'No Committee have been created.',
  'manager.institutions.noneCreated' => 'No institutions have been created.',
  'manager.institutions.create' => 'Create a new institution',
  'manager.institutions.form.nameRequired' => 'The name of the institution is required.',
  'manager.institutions.form.regionRequired' => 'The geographical area of the institution is required.',
  'manager.institutions.form.typeRequired' => 'The type of the institution is required.',
  ...
  'manager.people.allEnrolledUsers' => 'Users Enrolled in the Committee System',
  'manager.people.allJournals' => 'All Sites',
  'manager.people.allSiteUsers' => 'Enrol a User from this Site in the Committee System',
  ...
  'manager.sections.create' => 'Create a new Committee',
  ...
  'manager.sections.form.abbrevRequired' => 'An abbreviated title is required for the Committee',
  'manager.sections.form.abbrevAlreadyInUsed' => 'This abbreviated title is already in used by another committee.s',
  'manager.sections.form.regionRequired' => 'The region of the Committee is required',
  ...
  'manager.sections.form.titleRequired' => 'A title is required for the Committee.',
  'manager.sections.form.titleAlreadyUsed' => 'This title is already used by another committee.',
  ...
  'manager.setup.authorGuidelines' => 'Investigator Guidelines',
  'manager.setup.authorGuidelinesDescription' => 'Set out for investigators the bibliographic and formatting standards used for items submitted to the system (e.g.CV or questionnaires templates). If so, do not foreget ot upload them in the About page of this system and to provide a link. It is also useful to identify the types of appropriate Supplementary Files (e.g., data-sets, research instruments, etc.) which investigators should be encouraged to upload, in addition to their submission.',
  ...
  'manager.setup.submissionPreparationChecklistDescription' => 'On making a submission to the system, investigators are first asked to check each item on the Submission Preparation Checklist as completed, before proceeding. The checklist also appears in the Investigator Guidelines, under the About tab. The list can be edited below, but all items on the list will require a checkmark before investigators can proceed with their submission.',
  'manager.setup.submissions' => 'Submissions',
  'manager.setup.submissions.description' => 'Investigator guidelines, submission steps, copyright, and indexing (including registration).',
