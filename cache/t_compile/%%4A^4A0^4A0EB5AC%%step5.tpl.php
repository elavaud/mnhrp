<?php /* Smarty version 2.6.26, created on 2013-11-18 00:46:02
         compiled from author/submit/step5.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'author/submit/step5.tpl', 28, false),array('function', 'url', 'author/submit/step5.tpl', 30, false),array('function', 'fieldLabel', 'author/submit/step5.tpl', 459, false),array('function', 'call_hook', 'author/submit/step5.tpl', 506, false),array('modifier', 'escape', 'author/submit/step5.tpl', 31, false),array('modifier', 'to_array', 'author/submit/step5.tpl', 435, false),array('modifier', 'date_format', 'author/submit/step5.tpl', 438, false),)), $this); ?>
...
<p><?php echo $this->_tpl_vars['section']->getSectionTitle(); ?>
</p>
...
?>
	<tr valign="top">
        <td class="label" width="20%"><?php if ($this->_tpl_vars['author']->getPrimaryContact()): ?>Investigator<?php else: ?>Co-Investigator<?php endif; ?></td>
        <td class="value">
...
<br/><?php endif; ?>
			<?php if (( $this->_tpl_vars['author']->getPhoneNumber() ) != ""): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['author']->getPhoneNumber())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
<br/><?php endif; ?>
        </td>
    </tr>
...
<table class="listing" width="100%">
 ...
 <?php echo $this->_tpl_vars['article']->getLocalizedSelectedCurrency(); ?>
    ...
    <?php if (( $this->_tpl_vars['article']->getLocalizedNationwide() ) == 'No'): ?>
    <tr valign="top">
        <td class="label" width="20%">&nbsp;</td>
	...
	<?php if ($this->_tpl_vars['currentJournal']->getLocalizedSetting('waiverPolicy') != ''): ?>
		<?php if ($this->_tpl_vars['manualPayment']): ?>
			...
			<table class="data" width="100%">
				...
				<td width="95%">I sent my payment to the appropriate Ethics Review Committee.</td>
				</tr>
				<tr>
				<td />
								<tr>
