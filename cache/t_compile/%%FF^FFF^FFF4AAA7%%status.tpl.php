...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'sectionEditor/submission/status.tpl', 10, false),array('modifier', 'date_format', 'sectionEditor/submission/status.tpl', 66, false),)), $this); ?>
<div id="status">
	...
	<tr>
		...
		<td width="80%" class="value">
                        ...
                        <?php elseif ($this->_tpl_vars['status'] == PROPOSAL_STATUS_REVIEWED): ?>
                            ...
                            <?php elseif ($this->_tpl_vars['decision'] == SUBMISSION_SECTION_DECISION_EXEMPTED): ?><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submission.status.exempted"), $this);?>
