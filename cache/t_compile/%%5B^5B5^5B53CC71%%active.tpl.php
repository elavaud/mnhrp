<?php /* Smarty version 2.6.26, created on 2013-11-19 01:04:00
         compiled from reviewer/active.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'reviewer/active.tpl', 21, false),array('function', 'html_options_translate', 'reviewer/active.tpl', 25, false),array('function', 'translate', 'reviewer/active.tpl', 28, false),array('function', 'html_select_date', 'reviewer/active.tpl', 38, false),array('function', 'sort_heading', 'reviewer/active.tpl', 55, false),array('function', 'page_info', 'reviewer/active.tpl', 109, false),array('function', 'page_links', 'reviewer/active.tpl', 110, false),array('modifier', 'escape', 'reviewer/active.tpl', 32, false),array('modifier', 'date_format', 'reviewer/active.tpl', 74, false),array('block', 'iterate', 'reviewer/active.tpl', 66, false),)), $this); ?>
...
<table class="listing" width="100%">
	...
	<tr class="heading" valign="bottom">
		...
		<td width="55%"><?php echo $this->_plugins['function']['sort_heading'][0][0]->smartySortHeading(array('key' => "article.title",'sort' => 'title'), $this);?>
</td>
...
<?php $this->_tag_stack[] = array('iterate', array('from' => 'submissions','item' => 'submission')); $_block_repeat=true;$this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	<?php $this->assign('articleId', $this->_tpl_vars['submission']->getLocalizedProposalId()); ?>
