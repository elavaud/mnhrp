...
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'sectionEditor/index.tpl', 13, false),array('function', 'translate', 'sectionEditor/index.tpl', 18, false),array('function', 'html_options', 'sectionEditor/index.tpl', 34, false),array('function', 'html_options_translate', 'sectionEditor/index.tpl', 62, false),array('function', 'html_select_date', 'sectionEditor/index.tpl', 75, false),array('modifier', 'assign', 'sectionEditor/index.tpl', 13, false),array('modifier', 'escape', 'sectionEditor/index.tpl', 34, false),)), $this); ?>
...
<ul class="menu">
	<li class="current"><a class="action" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'index'), $this);?>
...
<ul class="menu">
	<li<?php if (( $this->_tpl_vars['pageToDisplay'] == 'submissionsSubmitted' )): ?> class="current"<?php endif; ?>><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('path' => 'submissionsSubmitted'), $this);?>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.submissionsInReview"), $this);?>
	...
	<li<?php if (( $this->_tpl_vars['pageToDisplay'] == 'submissionsApproved' )): ?> class="current"<?php endif; ?>><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('path' => 'submissionsApproved'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.submissionsApproved"), $this);?>
</a></li>
	<li<?php if (( $this->_tpl_vars['pageToDisplay'] == 'submissionsCompleted' )): ?> class="current"<?php endif; ?>><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('path' => 'submissionsCompleted'), $this);?>
