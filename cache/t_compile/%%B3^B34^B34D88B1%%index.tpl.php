...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.role.coordinator"), $this);?>
				...
				<td></td>
				<td align="left"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'editor','op' => 'submissions','path' => 'submissionsInReview'), $this);?>
">Proposals</a>
				</td>
				<td align="left"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'editor','op' => 'submissionsReport'), $this);?>
...
"><?php echo $this->_tpl_vars['user']->getErcFunction($this->_tpl_vars['ercId']); ?>
</a></td>
				<td align="left"></td>
				<td align="left"><?php if ($this->_tpl_vars['sectionEditorSubmissionsCount'][0]): ?>
						<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'sectionEditor','op' => 'index','path' => 'submissionsSubmitted'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.submissionsSubmitted"), $this);?>
 (<?php echo $this->_tpl_vars['sectionEditorSubmissionsCount'][0]; ?>
)</a>
					<?php else: ?><span class="disabled">0 <?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.submissionsSubmitted"), $this);?>
</span><?php endif; ?>
				</td>
				<td align="left"><?php if ($this->_tpl_vars['sectionEditorSubmissionsCount'][1]): ?>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.submissionsInReview"), $this);?>
 (<?php echo $this->_tpl_vars['sectionEditorSubmissionsCount'][1]; ?>
				...
				<td align="right"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'sectionEditor','op' => 'section','path' => $this->_tpl_vars['ercId']), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "section.sectionAbbrev"), $this);?>
			...
			<tr>
				<td></td>
				<td align="left"></td>
				<td align="left"><?php if ($this->_tpl_vars['sectionEditorSubmissionsCount'][2]): ?>
						<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'sectionEditor','op' => 'index','path' => 'submissionsApproved'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.submissionsApproved"), $this);?>
 (<?php echo $this->_tpl_vars['sectionEditorSubmissionsCount'][2]; ?>
)</a>
					<?php else: ?><span class="disabled">0 <?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.submissionsApproved"), $this);?>
</span><?php endif; ?>
				</td>
				<td align="left"><?php if ($this->_tpl_vars['sectionEditorSubmissionsCount'][3]): ?>
					<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'sectionEditor','op' => 'index','path' => 'submissionsCompleted'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.submissionsCompleted"), $this);?>
 (<?php echo $this->_tpl_vars['sectionEditorSubmissionsCount'][3]; ?>
)</a>
					<?php else: ?><span class="disabled">0 <?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.submissionsCompleted"), $this);?>
</span><?php endif; ?>
				</td>
				<td align="right"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'sectionEditor','op' => 'meetings'), $this);?>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.role.author"), $this);?>
				...
				<td align="left">
					<?php if ($this->_tpl_vars['authorSubmissionsCount'][0]): ?>
						<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'author','path' => 'proposalsToSubmit'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.proposalsToSubmit"), $this);?>
 (<?php echo $this->_tpl_vars['authorSubmissionsCount'][0]; ?>
					...
					<?php else: ?>
						<span class="disabled"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.proposalsToSubmit"), $this);?>
 (0)</span>
					<?php endif; ?>
				</td>
				<td align="left">					<?php if ($this->_tpl_vars['authorSubmissionsCount'][1]): ?>
						<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'author','path' => 'proposalsInReview'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.proposalsInReview"), $this);?>
 (<?php echo $this->_tpl_vars['authorSubmissionsCount'][1]; ?>
					...
					<?php else: ?>
						<span class="disabled"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.proposalsInReview"), $this);?>
 (0)</span>
					<?php endif; ?>
				</td>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "author.submit"), $this);?>
			...
			<tr>
				...
				<td></td>
				<td align="left">
					<?php if ($this->_tpl_vars['authorSubmissionsCount'][2]): ?>
						<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'author','path' => 'ongoingResearches'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.ongoingResearches"), $this);?>
 (<?php echo $this->_tpl_vars['authorSubmissionsCount'][2]; ?>
)</a> 					<?php else: ?>
						<span class="disabled"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.ongoingResearches"), $this);?>
 (0)</span>
					<?php endif; ?>
				</td>
				<td align="left">					<?php if ($this->_tpl_vars['authorSubmissionsCount'][3]): ?>
						<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'author','path' => 'completedResearches'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.completedResearches"), $this);?>
 (<?php echo $this->_tpl_vars['authorSubmissionsCount'][3]; ?>
)</a> 
					<?php else: ?>
						<span class="disabled"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.completedResearches"), $this);?>
 (0)</span>
					<?php endif; ?>
				</td>
				<td align="right">&nbsp;</td>
...
"><?php echo $this->_tpl_vars['user']->getErcAbbrevsOfReviewer(); ?>
</a></td>
				<td align="left">
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.completed"), $this);?>
 ...
 (0)</span>
				...
				<td align="right">
					<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'reviewer','op' => 'meetings'), $this);?>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.noRoles.submitArticle"), $this);?>
			...
			<li>
				...
				<?php if ($this->_tpl_vars['allowRegReviewer']): ?>
					<?php echo ((is_array($_tmp=$this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'user','op' => 'hrp'), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'userHomeUrl') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'userHomeUrl'));?>
