<?php /* Smarty version 2.6.26, created on 2013-11-17 22:22:38
         compiled from user/register.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'user/register.tpl', 23, false),array('modifier', 'assign', 'user/register.tpl', 39, false),array('modifier', 'urldecode', 'user/register.tpl', 236, false),array('modifier', 'nl2br', 'user/register.tpl', 251, false),array('function', 'url', 'user/register.tpl', 32, false),array('function', 'translate', 'user/register.tpl', 34, false),array('function', 'fieldLabel', 'user/register.tpl', 63, false),array('function', 'form_language_chooser', 'user/register.tpl', 66, false),array('function', 'html_options_translate', 'user/register.tpl', 127, false),array('function', 'html_options', 'user/register.tpl', 180, false),)), $this); ?>
...
" size="5" maxlength="5" class="textField" />&nbsp;&nbsp;<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.initialsExample"), $this);?>
		...
		<tr valign="top" id="affiliation">
			<td class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'affiliationField','key' => "user.affiliation"), $this);?>
</td>
			<td class="value">
...
<?php if (! ($this->_foreach['currentInterests']['iteration'] == $this->_foreach['currentInterests']['total'])): ?>, <?php endif; ?><?php endforeach; endif; unset($_from); ?>
	...
	<span class="instruct"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.interests.description"), $this);?>
</span>
</div> 
<br />
