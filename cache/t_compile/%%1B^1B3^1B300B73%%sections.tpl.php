<?php /* Smarty version 2.6.26, created on 2013-11-18 00:49:05
         compiled from manager/sections/sections.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sort_heading', 'manager/sections/sections.tpl', 30, false),array('function', 'translate', 'manager/sections/sections.tpl', 33, false),array('function', 'url', 'manager/sections/sections.tpl', 44, false),array('function', 'page_info', 'manager/sections/sections.tpl', 60, false),array('function', 'page_links', 'manager/sections/sections.tpl', 61, false),array('block', 'iterate', 'manager/sections/sections.tpl', 38, false),array('modifier', 'escape', 'manager/sections/sections.tpl', 40, false),)), $this); ?>
...
<table width="100%" class="listing" id="dragTable">
	...
	<tr class="heading" valign="bottom">
		<td width="50%"><?php echo $this->_plugins['function']['sort_heading'][0][0]->smartySortHeading(array('key' => "section.title",'sort' => 'title'), $this);?>
</td>
		<td width="15%"><?php echo $this->_plugins['function']['sort_heading'][0][0]->smartySortHeading(array('key' => "section.abbreviation",'sort' => 'abbrev'), $this);?>
</td>
		<td width="20%"><?php echo $this->_plugins['function']['sort_heading'][0][0]->smartySortHeading(array('key' => "section.region",'sort' => 'region'), $this);?>
</td>
...
" class="data">
		...
		<td class="drag"><?php echo ((is_array($_tmp=$this->_tpl_vars['section']->getLocalizedRegionText())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</td>
...
<?php if ($this->_tpl_vars['sections']->wasEmpty()): ?>
	<tr>
		<td colspan="4" class="nodata"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.sections.noneCreated"), $this);?>
</td>
	</tr>
	<tr>
		<td colspan="4" class="endseparator">&nbsp;</td>
...
<?php else: ?>
	<tr>
		...
		<td colspan="4" align="right"><?php echo $this->_plugins['function']['page_links'][0][0]->smartyPageLinks(array('anchor' => 'sections','name' => 'sections','iterator' => $this->_tpl_vars['sections'],'sort' => $this->_tpl_vars['sort'],'sortDirection' => $this->_tpl_vars['sortDirection']), $this);?>
</td>
	</tr>
<?php endif; ?>
</table>
