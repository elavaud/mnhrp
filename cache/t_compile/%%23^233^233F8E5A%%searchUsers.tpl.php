<?php /* Smarty version 2.6.26, created on 2013-11-20 12:25:34
         compiled from sectionEditor/searchUsers.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'sectionEditor/searchUsers.tpl', 17, false),array('function', 'html_options_translate', 'sectionEditor/searchUsers.tpl', 19, false),array('function', 'translate', 'sectionEditor/searchUsers.tpl', 22, false),array('function', 'sort_heading', 'sectionEditor/searchUsers.tpl', 52, false),array('function', 'page_info', 'sectionEditor/searchUsers.tpl', 75, false),array('function', 'page_links', 'sectionEditor/searchUsers.tpl', 76, false),array('modifier', 'escape', 'sectionEditor/searchUsers.tpl', 26, false),array('block', 'iterate', 'sectionEditor/searchUsers.tpl', 57, false),)), $this); ?>
...
<form name="submit" method="post" action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'enrollSearch','path' => $this->_tpl_vars['sectionId']), $this);?>
">
...
?><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'enrollSearch','path' => $this->_tpl_vars['sectionId'],'searchInitial' => $this->_tpl_vars['letter']), $this);?>
...
<?php endif; ?></a> <?php endforeach; endif; unset($_from); ?><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'enrollSearch','path' => $this->_tpl_vars['sectionId']), $this);?>
...
<div id="users">
<form action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'enroll','path' => $this->_tpl_vars['sectionId']), $this);?>
" method="post">
<table width="100%">
	<tr>
		<td width="15%" align="center"><b><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.enroll"), $this);?>
 *</b></td>
		<td width="85%">
			<select name="ercStatus" size="1" class="selectMenu">
				<option value="NA"></option>
				<option value="Chair"><?php echo $this->_tpl_vars['ercAbbrev']; ?>
 Chair</option>
				<option value="Vice-Chair"><?php echo $this->_tpl_vars['ercAbbrev']; ?>
 Vice-Chair</option>
				<option value="Secretary"><?php echo $this->_tpl_vars['ercAbbrev']; ?>
 Secretary</option>
				<option value="Member"><?php echo $this->_tpl_vars['ercAbbrev']; ?>
 Member</option>	
			</select>
		</td>
	</tr>
...
<tr class="heading" valign="bottom">
	...
	<td width="40%"><?php echo $this->_plugins['function']['sort_heading'][0][0]->smartySortHeading(array('key' => "user.email",'sort' => 'email'), $this);?>
</td>
</tr>
<tr><td colspan="5" class="headseparator">&nbsp;</td></tr>
...
" class="button defaultButton" /> <input type="button" value="<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.back"), $this);?>
" class="button" onclick="document.location.href='<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'section','path' => $this->_tpl_vars['sectionId']), $this);?>
'" />

</form>
<p><i><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.enrollment.info1"), $this);?>
</i></p>
