<?php /* Smarty version 2.6.26, created on 2013-11-19 11:49:12
         compiled from author/proposalsInReview.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'author/proposalsInReview.tpl', 12, false),array('function', 'sort_heading', 'author/proposalsInReview.tpl', 13, false),array('function', 'url', 'author/proposalsInReview.tpl', 32, false),array('function', 'page_info', 'author/proposalsInReview.tpl', 73, false),array('function', 'page_links', 'author/proposalsInReview.tpl', 74, false),array('block', 'iterate', 'author/proposalsInReview.tpl', 19, false),array('modifier', 'escape', 'author/proposalsInReview.tpl', 27, false),array('modifier', 'date_format', 'author/proposalsInReview.tpl', 28, false),array('modifier', 'strip_unsafe_html', 'author/proposalsInReview.tpl', 34, false),array('modifier', 'truncate', 'author/proposalsInReview.tpl', 34, false),)), $this); ?>
...
<?php $this->_tag_stack[] = array('iterate', array('from' => 'submissions','item' => 'submission')); $_block_repeat=true;$this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
    ...
    <?php $this->assign('proposalId', $this->_tpl_vars['submission']->getLocalizedProposalId($this->_tpl_vars['submission']->getLocale())); ?>
...
" class="action"><?php if ($this->_tpl_vars['abstract']->getScientificTitle()): ?><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['abstract']->getScientificTitle())) ? $this->_run_mod_handler('strip_unsafe_html', true, $_tmp) : String::stripUnsafeHtml($_tmp)))) ? $this->_run_mod_handler('truncate', true, $_tmp, 60, "...") : $this->_plugins['modifier']['truncate'][0][0]->smartyTruncate($_tmp, 60, "...")); ?>
<?php else: ?><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.untitled"), $this);?>
<?php endif; ?></a></td>
        <?php endif; ?>
        <td align="right">
        	<?php if ($this->_tpl_vars['status'] == PROPOSAL_STATUS_SUBMITTED): ?>
            	<?php $this->assign('count', $this->_tpl_vars['count']+1); ?>
            	<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submission.status.submitted"), $this);?>
<br />
...
" class="action" ><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.withdraw"), $this);?>
        	...
        	<?php elseif ($this->_tpl_vars['status'] == PROPOSAL_STATUS_CHECKED): ?>
                <?php $this->assign('count', $this->_tpl_vars['count']+1); ?>
                <?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submission.status.complete"), $this);?>
<br />
                <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'withdrawSubmission','path' => $this->_tpl_vars['articleId']), $this);?>
" class="action" ><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.withdraw"), $this);?>
</a>
            ...
            <?php elseif ($this->_tpl_vars['status'] == PROPOSAL_STATUS_EXPEDITED): ?>
                <?php $this->assign('count', $this->_tpl_vars['count']+1); ?>
                <?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submission.status.expeditedReview"), $this);?>
<br />
                <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'withdrawSubmission','path' => $this->_tpl_vars['articleId']), $this);?>
" class="action" ><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.withdraw"), $this);?>
</a>

            <?php elseif ($this->_tpl_vars['status'] == PROPOSAL_STATUS_FULL_REVIEW): ?>
                <?php $this->assign('count', $this->_tpl_vars['count']+1); ?>
                <?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submission.status.fullReview"), $this);?>
<br />
                <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'withdrawSubmission','path' => $this->_tpl_vars['articleId']), $this);?>
" class="action" ><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.withdraw"), $this);?>
</a>
