<?php /* Smarty version 2.6.26, created on 2013-11-17 22:34:54
         compiled from manager/people/enrollment.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'manager/people/enrollment.tpl', 16, false),array('function', 'translate', 'manager/people/enrollment.tpl', 34, false),array('function', 'html_options_translate', 'manager/people/enrollment.tpl', 70, false),array('function', 'sort_heading', 'manager/people/enrollment.tpl', 118, false),array('function', 'icon', 'manager/people/enrollment.tpl', 138, false),array('function', 'page_info', 'manager/people/enrollment.tpl', 169, false),array('function', 'page_links', 'manager/people/enrollment.tpl', 170, false),array('modifier', 'escape', 'manager/people/enrollment.tpl', 34, false),array('modifier', 'wordwrap', 'manager/people/enrollment.tpl', 131, false),array('modifier', 'concat', 'manager/people/enrollment.tpl', 135, false),array('modifier', 'assign', 'manager/people/enrollment.tpl', 136, false),array('modifier', 'to_array', 'manager/people/enrollment.tpl', 137, false),array('modifier', 'truncate', 'manager/people/enrollment.tpl', 138, false),array('block', 'iterate', 'manager/people/enrollment.tpl', 127, false),)), $this); ?>
...
">
	<select name="roleSymbolic" class="selectMenu">
		...
		<option <?php if ($this->_tpl_vars['roleSymbolic'] == 'extReviewers'): ?>selected="selected" <?php endif; ?>value="extReviewers"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.ercrole.extReviewers"), $this);?>
</option>
...
<table width="100%" class="listing">
	...
	<tr class="heading" valign="bottom">
		...
		<td width="25%"><?php echo $this->_plugins['function']['sort_heading'][0][0]->smartySortHeading(array('key' => "user.email",'sort' => 'email'), $this);?>
</td>
