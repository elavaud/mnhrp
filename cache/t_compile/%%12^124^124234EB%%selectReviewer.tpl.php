<?php /* Smarty version 2.6.26, created on 2013-11-20 11:41:42
         compiled from sectionEditor/selectReviewer.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'sectionEditor/selectReviewer.tpl', 29, false),array('function', 'url', 'sectionEditor/selectReviewer.tpl', 32, false),array('function', 'html_options_translate', 'sectionEditor/selectReviewer.tpl', 39, false),array('function', 'sort_search', 'sectionEditor/selectReviewer.tpl', 61, false),array('function', 'math', 'sectionEditor/selectReviewer.tpl', 96, false),array('function', 'page_info', 'sectionEditor/selectReviewer.tpl', 120, false),array('function', 'page_links', 'sectionEditor/selectReviewer.tpl', 121, false),array('modifier', 'escape', 'sectionEditor/selectReviewer.tpl', 46, false),array('modifier', 'urldecode', 'sectionEditor/selectReviewer.tpl', 80, false),array('modifier', 'string_format', 'sectionEditor/selectReviewer.tpl', 82, false),array('modifier', 'date_format', 'sectionEditor/selectReviewer.tpl', 101, false),array('modifier', 'default', 'sectionEditor/selectReviewer.tpl', 102, false),array('modifier', 'to_array', 'sectionEditor/selectReviewer.tpl', 107, false),array('block', 'iterate', 'sectionEditor/selectReviewer.tpl', 73, false),)), $this); ?>
<?php echo ''; ?><?php $this->assign('pageTitle', "editor.article.selectReviewer"); ?><?php echo ''; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
<h3><?php if ($this->_tpl_vars['extReviewers'] == false): ?><?php echo $this->_tpl_vars['ercAbbrev']; ?>
 Members<?php elseif ($this->_tpl_vars['extReviewers'] == true): ?><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.ercrole.extReviewers"), $this);?>
<?php endif; ?></h3>
...
">
	...
	<select name="extReviewers" size="1" class="selectMenu">
		<option value=false <?php if ($this->_tpl_vars['extReviewers'] == false): ?> selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['ercAbbrev']; ?>
 Members</option>
		<option value=true <?php if ($this->_tpl_vars['extReviewers'] == true): ?> selected="selected"<?php endif; ?>><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.ercrole.extReviewers"), $this);?>
</option>
	</select>
...
<p><a class="action" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'enrollSearch','path' => $this->_tpl_vars['submission']->getSectionId()), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "sectionEditor.review.enrollReviewer"), $this);?>
</a>&nbsp;|&nbsp;<a class="action" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'createReviewer','path' => $this->_tpl_vars['submission']->getSectionId()), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "sectionEditor.review.createReviewer"), $this);?>
</a>&nbsp;|&nbsp;<a class="action" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'createExternalReviewer','path' => $this->_tpl_vars['submission']->getSectionId()), $this);?>
