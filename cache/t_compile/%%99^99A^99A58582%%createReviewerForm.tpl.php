<?php /* Smarty version 2.6.26, created on 2013-11-20 12:24:36
         compiled from sectionEditor/createReviewerForm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'sectionEditor/createReviewerForm.tpl', 23, false),array('modifier', 'to_array', 'sectionEditor/createReviewerForm.tpl', 32, false),array('modifier', 'assign', 'sectionEditor/createReviewerForm.tpl', 67, false),array('modifier', 'urldecode', 'sectionEditor/createReviewerForm.tpl', 142, false),array('function', 'url', 'sectionEditor/createReviewerForm.tpl', 32, false),array('function', 'translate', 'sectionEditor/createReviewerForm.tpl', 44, false),array('function', 'fieldLabel', 'sectionEditor/createReviewerForm.tpl', 65, false),array('function', 'form_language_chooser', 'sectionEditor/createReviewerForm.tpl', 68, false),array('function', 'html_options_translate', 'sectionEditor/createReviewerForm.tpl', 99, false),array('function', 'html_options', 'sectionEditor/createReviewerForm.tpl', 159, false),)), $this); ?>
...
<form method="post" name="reviewerForm" action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'createReviewer','path' => ((is_array($_tmp=$this->_tpl_vars['sectionId'])) ? $this->_run_mod_handler('to_array', true, $_tmp, 'create') : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, 'create'))), $this);?>
">
...
<p><h3><?php echo $this->_tpl_vars['erc']->getLocalizedTitle(); ?>
</h3><br/></p>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['localeName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
	...
	-->
	<tr>
		<td class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'ercStatus','required' => 'true','key' => "common.enroll"), $this);?>
</td>
		<td class="value">
			<select name="ercStatus" size="1" class="selectMenu">
				<option value=""></option>
				<option value="Chair"><?php echo $this->_tpl_vars['erc']->getLocalizedAbbrev(); ?>
 Chair</option>
				<option value="Vice-Chair"><?php echo $this->_tpl_vars['erc']->getLocalizedAbbrev(); ?>
 Vice-Chair</option>
				<option value="Secretary"><?php echo $this->_tpl_vars['erc']->getLocalizedAbbrev(); ?>
 Secretary</option>
				<option value="Member"><?php echo $this->_tpl_vars['erc']->getLocalizedAbbrev(); ?>
 Member</option>	
			</select>
		</td>
	</tr>
